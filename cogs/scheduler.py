...
class Scheduler(commands.Cog):
    ...
    def schedule_tasks(self):
        ...
        self.scheduler.add_job(
            ...
            args=["***Incoming Transmission from Squadron HQ, Crimson Hollow***", "Weapons Hot!", "Friday Night Fights are about to begin — rally in Deep Space!", discord.Color.dark_red(), "<:TieDefender:682583044783341570>", "images/abyssal_squadron_banner.jpg"]
        )
